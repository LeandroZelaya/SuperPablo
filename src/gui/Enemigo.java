...
public class Enemigo {
    ...
    public Enemigo(int x, int y, int limite1, int limite2,  String tipo, int direccion){
	    ...
	    switch(tipo) {
	        ...
	        case "bandido" -> vida = 3;
	        case "volador1" -> vida= 1;
	        case "volador2" -> vida=1;
	        default -> vida = 1;
	    }
	    ...
	    switch(tipo) {
	        ...
	        case "volador1" -> { ancho = 40; alto = 40;}
	        case "volador2" -> { ancho = 40; alto = 40;}
	    }
	    
	    this.x = x;
	    this.y = y - alto;
	    if(tipo.equals("volador1"))
	    {
    ...
    public void draw(Graphics g, int camaraX, int paso) {
        if(vivo) {
            ...
            if(tipo.equals("volador1")) { g.setColor(Color.GREEN); g.fillRect(x - camaraX, y, ancho, alto); }else {
    ...
    public int getPuntos()
    {
    	...
    	{
    		num=6;
    	}else if(tipo.startsWith("volador"))
    	{
    		num=2;
    	}
    	return 10 * num;
