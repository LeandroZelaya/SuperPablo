...
public class SuperPablo extends JPanel implements Runnable, KeyListener {
    ...
    {
    	enemigos.add(new Enemigo(660, sueloNivel1, 550, 800, "volador1",1));
        enemigos.add(new Enemigo(800, sueloNivel1, 800, 950, "esqueleto",1));
        enemigos.add(new Enemigo(950, sueloNivel1, 950, 1100, "esqueleto",1));
        enemigos.add(new Enemigo(1050, sueloNivel1, 1000, 1150, "caballero",1));
        enemigos.add(new Enemigo(1100, sueloNivel1, 1100, 1250, "esqueleto",1));
        enemigos.add(new Enemigo(1150, sueloNivel1, 1150, 1250, "esqueleto",1));
        enemigos.add(new Enemigo(1300, sueloNivel1, 1250, 1400, "caballero",1));
        enemigos.add(new Enemigo(1300, sueloNivel1, 1300, 1450, "bandido",1));
    }
    ...
    {
    	enemigos.add(new Enemigo(600, sueloNivel2, 550, 800, "esqueleto",1));
        enemigos.add(new Enemigo(800, sueloNivel2, 800, 950, "caballero",1));
        enemigos.add(new Enemigo(950, sueloNivel2, 950, 1100, "bandido",1));
        enemigos.add(new Enemigo(1050, sueloNivel2, 1000, 1150, "caballero",1));
        enemigos.add(new Enemigo(1100, sueloNivel2, 1100, 1250, "esqueleto",1));
        enemigos.add(new Enemigo(1150, sueloNivel2, 1150, 1250, "esqueleto",1));
        enemigos.add(new Enemigo(1300, sueloNivel2, 1250, 1400, "bandido",1));
        enemigos.add(new Enemigo(1300, sueloNivel2, 1300, 1450, "bandido",1));
    }

    private void cargarPlataformasNivel2()
    {
    	plataformas.add(new Plataforma("pasto", 0, 650, 600));
    }
    ...
    {
    	enemigos.add(new Enemigo(600, sueloNivel3, 550, 800, "caballero",1));
        enemigos.add(new Enemigo(800, sueloNivel3, 800, 950, "esqueleto",1));
        enemigos.add(new Enemigo(950, sueloNivel3, 950, 1100, "caballero",1));
        enemigos.add(new Enemigo(1050, sueloNivel3, 1000, 1150, "caballero",1));
        enemigos.add(new Enemigo(1100, sueloNivel3, 1100, 1250, "bandido",1));
        enemigos.add(new Enemigo(1150, sueloNivel3, 1150, 1250, "bandido",1));
        enemigos.add(new Enemigo(1300, sueloNivel3, 1250, 1400, "bandido",1));
        enemigos.add(new Enemigo(1300, sueloNivel3, 1300, 1450, "bandido",1));
        
        
    }

    private void cargarPlataformasNivel3(int camaraX)
    {
    	// falta esto
    }
     ...
     // Dentro del método update()
        ...
        if (nivelActual == 2) {
            ...
            Rectangle marcadorCastilloRect = new Rectangle(
                fondoNivel2.getXMarcadorCastillo() + camaraX,
        ...
        if (jugador.getX() + camaraX > 5700 && nivelActual == 3 && !wilsonCreado) {
        	wilson = new Wilson(camaraX + 1450, 532, 100, 160);
        	wilsonCreado=true;
        }
        ...
        if(wilsonCreado && wilson.estaVivo())
        {
        	...
        	colisionWilson();
        	colisionProyectiles();
        	if (fase == 0 && wilson.getVida() <= 8) {
        		wilson.habilitar(false);
        	    fase = 1;
        	    wilson.invocarEnemigos(camaraX, sueloNivel3, fase, enemigosJ);
        	}
        	else if (fase == 1 && wilson.getVida() <= 7) {
        		wilson.habilitar(false);
        	    fase = 2;
        	    wilson.invocarEnemigos(camaraX, sueloNivel3, fase, enemigosJ);
        	}
        	else if (fase == 2 && wilson.getVida() <= 6) {
        		wilson.habilitar(false);
        	    fase = 3;
        	    wilson.invocarEnemigos(camaraX, sueloNivel3, fase, enemigosJ);
        	}
        	else if (fase == 3 && wilson.getVida() <= 5) {
        		wilson.habilitar(false);
        	    fase = 4;
        	    wilson.invocarEnemigos(camaraX, sueloNivel3, fase, enemigosJ);
    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (estado) {
            ...
            case WIN:
            	...
            	g.setColor(Color.YELLOW);
            	g.setFont(perderFuente);
            	g.drawString("HAS GANADO", getWidth()/2 - 188, getHeight()/2);
            	g.setColor(Color.RED);
            	g.setFont(miFuente);
            	g.drawString("- Presione R para volver a jugar -", getWidth()/2 - 272, getHeight()/2 + 60);
            	break;
